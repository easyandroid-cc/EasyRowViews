...
public abstract class DialogRowView extends RowView implements OnDismissListener, DialogInterface.OnClickListener {

    public DialogRowView(Context context) {
        super(context);
    }

    public DialogRowView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public DialogRowView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private CharSequence mPositiveButtonText = getResources().getText(R.string.confirm);
    private CharSequence mNegativeButtonText = getResources().getText(R.string.cancel);
